...
const hoodies = (props) => {
  const productSlug = "example-product-hoodies";
  return (
    <div>
      <Head>
        <title>Hoodies :- Coding Tshirt</title>
      </Head>
      <section className="text-gray-600 body-font ml-10 mr-10 mt-24 min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            {/* {Object.keys(props.products.length === 0) && <p>Sorry all the hoodies are not available(OUT OF STOCK). New stock is coming soon... Stay Tuned</p>} */}
