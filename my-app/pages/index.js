...
export default function Home() {
  return (
    <>
      <Head>
        <title>Coding Shirt: Wear a Code</title>
      ...
      <div>
        <img style={{ margin: "auto",marginTop: "24px" }} src="https://img.freepik.com/free-vector/hacker-operating-laptop-cartoon-icon-illustration-technology-icon-concept-isolated-flat-cartoon-style_138676-2387.jpg?size=338&ext=jpg&ga=GA1.1.2113030492.1719619200&semt=ais_user" alt="" />
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Buy and Wear the Code</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">The Best Programmers Write Code that Humans Can Read and Machines Can Execute</p>
          </div>
